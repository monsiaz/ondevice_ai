...
struct LocalizedString {
    ...
    private static let englishStrings: [String: String] = [
        ...
        "developer": "Developer",
        "logs_memory": "Logs & Memory",
        "clear_cache": "Clear app cache (models & history)",
        "clear_cache_title": "Clear Cache",
        "clear_cache_message": "This will delete all downloaded models and conversation history. This action cannot be undone.",
        "cache_cleared_title": "Cache Cleared",
        "system_ai": "System AI",
        "apple_intelligence": "Apple Intelligence",
        "neural_engine_model": "Neural Engine • System Model",
        "default": "Default",
        "downloaded_models_mlx": "Downloaded Models (MLX)",
        "download_more_models": "Download More Models",
        "no_models_installed": "No models installed. Download one from the Available tab.",
        "copy": "Copy",
        "share": "Share",
        "listen": "Listen",
        "stop": "Stop",
    ...
    private static let frenchStrings: [String: String] = [
        ...
        "animation_scroll": "Animation et défilement",
        "bubble_animation": "Animation d'entrée des bulles",
        "smooth_scroll": "Défilement fluide",
        ...
        "voice_permission_note": "Les fonctions vocales nécessitent l'autorisation du microphone. Vous serez invité si nécessaire.",
        "controls_language_note": "Contrôle la langue de l'app, la dictée vocale et la synthèse vocale.",
        "customize_ai_note": "Personnalisez le comportement et les réponses de l'IA",
        "developer": "Développeur",
        "logs_memory": "Logs et mémoire",
        "clear_cache": "Effacer le cache (modèles et historique)",
        "clear_cache_title": "Effacer le cache",
        "clear_cache_message": "Cela supprimera tous les modèles téléchargés et l'historique des conversations. Cette action est irréversible.",
        "cache_cleared_title": "Cache effacé",
        "system_ai": "IA système",
        "apple_intelligence": "Apple Intelligence",
        "neural_engine_model": "Neural Engine • Modèle système",
        "default": "Défaut",
        "downloaded_models_mlx": "Modèles téléchargés (MLX)",
        "download_more_models": "Télécharger plus de modèles",
        "no_models_installed": "Aucun modèle installé. Téléchargez-en un depuis l'onglet Disponible.",
        "copy": "Copier",
        "share": "Partager",
        "listen": "Écouter",
        "stop": "Arrêter",
